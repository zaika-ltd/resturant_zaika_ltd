...
import '../widget/transaction_report_widget.dart';

class WeeklyTransactionReportScreen extends StatefulWidget {
  const WeeklyTransactionReportScreen({super.key});

  @override
  State<WeeklyTransactionReportScreen> createState() => _WeeklyTransactionReportScreenState();
}

class _WeeklyTransactionReportScreenState extends State<WeeklyTransactionReportScreen> {
      ...
      return Scaffold(
        ...
        appBar: CustomAppBarWidget(
          ...
          menuWidget: Padding(
            ...
            child: InkWell(
              onTap: () => reportController.showDatePicker(context, transactionDateWise: true),
              child: Stack(
        ...
        body: reportController.reportSummary != null ? SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    ...
                    TransactionStatusCardWidget(
                      isCompleted: true,
                      amount:( reportController.completedTransactionsDateWise??0).toDouble(),
                    ...
                    TransactionStatusCardWidget(
                      isOnHold: true,
                      amount: ( reportController.onHoldDateWise??0).toDouble(),
                      onHoldToolTip: onHoldToolTip,
                    ),
                    const SizedBox(width: Dimensions.paddingSizeDefault),

                    TransactionStatusCardWidget(
                      amount: ( reportController.canceledDateWise??0).toDouble(),
            ...
            TransactionReportDetail(orderTransactions:reportController.reportSummary!)
