                                  ...
                                  children: [
                                    ...
                                    Column(children: [
                                      ...
                                      restController.selectedNutritionList !=
                                          ...
                                          : const SizedBox(),
                                      if (ApiChecker.errors['nutritions'] !=
                                          null)
                                        Padding(
                                          padding:
                                    ...
                                    Column(children: [
                                      ...
                                      restController
                                          ...
                                          : const SizedBox(),
                                      if (ApiChecker.errors['allergies'] !=
                                          null)
                                        Padding(
                                          padding:
                                              const EdgeInsets.only(top: 4.0),
